    ...
    return (
      <div>
        ...
        <section id="headerImgIndex">
          ...
          <div class="parallax" data-velocity="-.2" data-fit="525">
            <div id="fixedWidth">
              <div id="window">
                <div id="textWindow">
                  <h1> Recycle Your Electronics, Batteries, And Other Materials </h1>
                  <h1> </h1>
                </div>
        ...
        <div id="overviewI">
          ...
          <div id="desc">
            <div id="header3">
              <h1><b>Download The Official Remine India's Android App!</b></h1>
              <h1>
                <p>Recycling electronics has never been easier! Download our official android application for a mobile, versatile experience!</p>
                <a href=''>
                <p>Download Here</p>
              </a></h1>
            </div>
